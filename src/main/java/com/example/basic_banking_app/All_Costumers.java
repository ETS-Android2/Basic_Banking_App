...
public class All_Costumers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_costumers);

        recyclerView = findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        transaction_history = (Button)findViewById(R.id.button3);
        ...
        transaction_history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                while(res.moveToNext()){
                    buffer.append("Sender :"+res.getString(0)+"\n");
                    buffer.append("Reciever :"+res.getString(1)+"\n");
                    buffer.append("Money :"+res.getString(2)+"\n\n");
                }

                AlertDialog.Builder builder = new AlertDialog.Builder(All_Costumers.this);
